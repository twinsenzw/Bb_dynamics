...
double constraint(const vector<double> &present_p, vector<double> &grad, void *data) 
{
...
double objective(const vector<double> &present_p, vector<double> &grad, void *data) 
{
	...
	p.p0=present_p[0]; //cells -1 hours -1
...
int main()
{
 ...
 //=======fitting===========
	...
	vector<double> present_p(2);
	//present_p[0]=0.9;
	//present_p[0]=0.02; //psai
	//present_p[1]=0.5; //phi
	present_p[0]=0.8; //p0
	...
	cout<<present_p[0]<<"\t"<<present_p[1]<<endl;
